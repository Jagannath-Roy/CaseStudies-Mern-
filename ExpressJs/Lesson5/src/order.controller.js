...
var OrderController = function () {
    var _classDecorators = [(0, routing_controllers_1.JsonController)("/orders")];
    ...
    var OrderController = _classThis = /** @class */ (function () {
        function OrderController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        OrderController_1.prototype.getAllOrders = function () {
            return { status: "Succes", data: order_store_1.orders };
        };
        OrderController_1.prototype.getOrderById = function (id) {
            var order = order_store_1.orders.find(function (o) { return id === o.id; });
            if (!order) {
                return { status: "error", error: "Order not found" };
            }
            return { status: "Succes", data: order };
        };
        OrderController_1.prototype.createOrder = function (order) {
            var newOrder = __assign(__assign({}, order), { id: (order_store_1.orders.length + 1).toString(), bakingStatus: "Pending" });
            order_store_1.orders.push(newOrder);
    ...
    (function () {
        ...
        _getAllOrders_decorators = [(0, routing_controllers_1.Get)("/")];
        _getOrderById_decorators = [(0, routing_controllers_1.Get)("/:id")];
        _createOrder_decorators = [(0, routing_controllers_1.Post)("/")];
